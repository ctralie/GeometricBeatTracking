#My original approach was to compute circular coordinates, to eliminate bad blocks
#based on liner regression, and to do a median merge of different blocks to get a single
#function for circular coordinates over all time points
import numpy as np
